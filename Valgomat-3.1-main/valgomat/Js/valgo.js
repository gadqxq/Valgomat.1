    ...
    const questions = [
        ...
        {
            question: "Spørsmål 2: Hva synes du om pensjonsalderen? Burde den være lavere?",  
            options: [
                { text: "Meget uenig", value: 1 },
                { text: "Uenig", value: 2 },
                { text: "Nøytral", value: 3 },
        ...
        {
            question: "Spørsmål 3: Hva synes du om utbetalingsmengden for nypensjonister? er den høy nok?",
            options: [
                { text: "Meget uenig", value: 1 },
                { text: "Uenig", value: 2 },
                { text: "Nøytral", value: 3 },
        ...
        {
            question: "Spørsmål 4: Burde pensjonister ha tilgang til rimelig boligtilbud og beskyttelse mot diskriminering på boligmarkedet?",
            options: [
                { text: "Meget uenig", value: 1 },
                { text: "Uenig", value: 2 },
                { text: "Nøytral", value: 3 },
